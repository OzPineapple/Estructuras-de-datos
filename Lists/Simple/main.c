...
main (int argc, char *argv[])
{
  ...
  printNode (getNodeOnListSimple
	     (list_simple,
	      randomInRange (0, lengthOfListSimple (list_simple) - 1)));

  printf ("\nListSimple.h - Write\n");

  for (size_t i = 0; i < 10; i++)
    writeOnListSimple (list_simple,
		       randomInRange (0,
				      lengthOfListSimple (list_simple) - 1),
  ...
  for (size_t i = 0; i < 10; i++)
    printf ("%i ",
	    readOnListSimple (list_simple,
			      randomInRange (0,
					     lengthOfListSimple (list_simple)
					     - 1)));
  printf ("\n");
  ...
  for (size_t i = 0; i < 10; i++)
    deleteOnListSimple (list_simple,
			randomInRange (0,
				       lengthOfListSimple (list_simple) - 1));
  ...
  destroyNodeOnListSimpleNlink (&list_simple,
				randomInRange (0,
					       lengthOfListSimple
					       (list_simple) - 1));
